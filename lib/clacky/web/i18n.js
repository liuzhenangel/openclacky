...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "channels.hint.enabled":          "⚠ Enabled but not running — the adapter may have failed to connect. Run E2E Test to diagnose.",
      "channels.hint.enabledNotRunning":"Enabled but not running — the adapter may have failed to connect. Run E2E Test to diagnose.",
      ...
      "channels.btn.test":        "Run E2E Test",
    ...
    zh: {
      ...
      "channels.hint.enabled":          "⚠ 已启用但未运行 — 适配器可能连接失败，请运行 E2E 测试诊断。",
      "channels.hint.enabledNotRunning":"已启用但未运行 — 适配器可能连接失败，请运行 E2E 测试诊断。",
      "channels.hint.idle":             "尚未配置。点击「用 Agent 配置」开始。",
      "channels.hint.notConfigured":    "尚未配置。点击「用 Agent 配置」开始。",
      "channels.btn.test":        "运行 E2E 测试",
